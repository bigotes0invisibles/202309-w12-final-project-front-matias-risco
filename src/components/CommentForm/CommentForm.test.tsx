...
describe("Given the component CommentForm", () => {
  ...
  describe("When it is render and the user write a New Comment and there is a game in store, but there is a Error", () => {
    test("then the user should see the messasge 'Error in upload comment'", async () => {
      server.use(...handlersError);
      const expectButtonDisable = false;
      const commentText = "alfa omega beta";
      const expectedToastText = "Error in upload comment";
